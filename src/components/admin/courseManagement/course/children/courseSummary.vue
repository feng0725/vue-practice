    ...
    <div class="courseSummary edit-new">
        ...
        <div class="wrapper clearfix">
                        ...
                        <div class="box" v-show="item.edit">
                            ...
                            >
                                ...
                                <FormItem label=" 内容类型(必选)" prop="sectionType">
                                    <Select :disabled="fileFlag" v-model="sectionItem.sectionType" style="width:200px"
                                ...
                                <FormItem :label="courseRequired" prop="vCode"
                                    ...
                                    <div>
                                        <div class="upload-box">
                                            <Button :disabled="videoFlag || sectionItem.courseSectionFile.length == 2"
                                            ...
                                            <Upload :show-upload-list="false"
                                                ...
                                                <Button
                                                    :disabled="sectionItem.courseSectionFile.length == 2 || fileFlag"
                                                    class="white-blue">上传文件
                                                </Button>
                                            </Upload>
                                        </div>

                                        <div v-for="(item,index) in sectionItem.courseSectionFile" class="file-box">
                                            <div>
                                                <span :title="item.fileName">
                                                {{item.fileName}}
                                                </span>
                                                <Icon size="15" class="icon-close"
                                                      @click="removeCourseSectionFile(index)"
            ...
            <div class="btn-box fl">
                ...
                <Button v-if="courseMsg.draftStatus" class="btn fr white-blue" @click="saveDraft" type="primary">保存草稿
                </Button>
        ...
        <MyDialog width="380" class-name="select-list" @ok="setVideo" :title="'选择视频'" :visible.sync="isVideoList">
...
export default {
    ...
    methods: {
        ...
        removeCourseSectionFile(index) {
            ...
            let item = this.sectionItem.courseSectionFile[index];
            console.log(item);
            let regexp = /\.(mp4|mkv|avi|rmvb|rm)$/i;
        ...
        changeSectionTyep(val) {
            this.sectionItem.courseSectionFile = this.sectionItem.courseSectionFile.filter((item) => {
                let regexp = /\.(mp4|mkv|avi|rmvb|rm)$/i;
                return !regexp.test(item.fileName);
            });
            this.videoFlag = false;
        ...
        setVideo() {
            ...
            this.sectionItem.courseSectionFile.push(obj);
            this.videoFlag = true;
        ...
        next() {
            ...
            this.$router.push({
                path: '/courseManagement/course/courseIntroduction',
                query: {
