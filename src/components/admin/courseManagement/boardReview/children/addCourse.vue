            ...
            sectionList: [
                {
                    courseSectionFile: [
                        ...
                        },
                        {
                            fileName: '1111',
                            fileUrl: '',
                            originalName: '234.png',
                            yunfileId: ''
                        }
                    ],
                    endTime: '2018-08-30 09:36:24',
                    sectionName: '小节名字',
                    sectionRemarks: '小节备注',
                    sectionType: '',
                    startTime: '2018-08-30 09:36:24',
                    lecturerName: '主讲教师名'
                }
            ]
        };
    ...
    methods: {
        ...
        async edit() {
            if (this.courseId) {
                ...
                this.enterpriseId = this.courseMsg.enterpriseId;
                this.getEnterpriseUserList();
        ...
        next: function() {
            this.$refs.courseMsg.validate((valid) => {
                if (valid) {
                    ...
                    if (this.courseId) {
                        this.$router.push({
                            path: '/courseManagement/review/courseSummary',
